...
protected:
	...
	bool collisionSlope(sf::FloatRect& hitbox, int sx, int sy, int& tsx, int& tsy);	//Tests for collisions against a slope at sx, sy - if a slope is found y is set accordingly
};